...
padding = len(simjob_str) - len(feature_vector) #added padding to make the lengths the same between feature vector and simjob_str 
feature_vector = np.pad(feature_vector, ((0, padding), (0, 0)), mode='constant')
